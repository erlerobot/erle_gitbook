...
An **autopilot is the software that provides assistance while controlling a drone**. While many autopilots allow the drone to fly autonomously following some pre-specified geographical points (e.g. using GPS), the autonomous flight is a characeristic of the autopilot but not the autopilot itself.
...
To understand this better, let's analyze different ways of controlling a **quadcopter**:
