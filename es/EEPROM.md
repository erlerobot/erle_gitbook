...
| Versión | 4 | Código Versión de hardware para la tarjeta en **ASCII**: ` ¿ 00Aï ¼ 3 ` para Rev A3, ` 00A4 ` para Rev A4, ` 00A5 ` para Rev A5, ` 00A6 ` para Rev A6 |
| Número de serie | 12 | Número de serie de la placa. 12 cadena de caracteres ASCII es ** ** con el siguiente esquema: ` WWYY4P16nnnn ` , donde ` WW ` es una semana de 2 dígitos del año de fabricación, ` YY ' se corresponde con el año de fabricación, ` ` nnnn es un tablero de incrementar número. |
